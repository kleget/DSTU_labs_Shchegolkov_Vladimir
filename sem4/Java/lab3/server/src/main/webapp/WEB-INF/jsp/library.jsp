...
<form action="<%= request.getContextPath() %>/library" method="get">
    <label>Жанр:
        <input name="genre" value="<%= esc(genre) %>" placeholder="programming">
    </label>
...
<form action="<%= request.getContextPath() %>/library" method="post">
    ...
    <p><label>Название: <input name="title" required></label></p>
    <p><label>Автор: <input name="author" required></label></p>
    <p><label>Жанр: <input name="genre" required placeholder="programming"></label></p>
    <p><label>Год: <input name="year" required></label></p>
